...
/*Enable debug IO*/
#define EN_DEBUG_IO
#define TP_DebugPrintf(arg, ...) SPRT_PrintString(arg)
#define FLS_DebugPrintf(arg, ...) SPRT_PrintString(arg)
#define APP_DebugPrintf(arg, ...) SPRT_PrintString(arg)
#define UDS_DebugPrintf(arg, ...) SPRT_PrintString(arg)
