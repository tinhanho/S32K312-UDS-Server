...
void Flash_SavePrintfigner(const uint8 *i_pPrintfigner, const uint8 i_printfinerLen)
{
    ...
    MemAcc_Erase(MEMACC_ADDRESS_AREA_0_ID, DATA_FLASH_FW_FINGERPRINT_ADDR, 0x2000);
	...
	MemAcc_Write(MEMACC_ADDRESS_AREA_0_ID, DATA_FLASH_FW_FINGERPRINT_ADDR, i_pPrintfigner, i_printfinerLen);
	while (MEMACC_JOB_IDLE != MemAcc_GetJobStatus(MEMACC_ADDRESS_AREA_0_ID))
	{
	    MemAcc_MainFunction();
	}
	...
	// }
	// if(C40_IP_STATUS_SUCCESS != C40_Ip_MainInterfaceWrite(APP_STATUS_ADDRESS, i_printfinerLen, i_pPrintfigner, 0))
	// {
	// 	return FALSE;
	// }
